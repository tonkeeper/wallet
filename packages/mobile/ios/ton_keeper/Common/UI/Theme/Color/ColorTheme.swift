...
protocol ColorTheme {
    ...
    var bgTransparent: UIColor { get }
    var acPrimary: UIColor { get }
    var acInactive: UIColor { get }
...
struct LightColorTheme: ColorTheme {
    ...
    let bgTransparent =  #colorLiteral(red: 0.06274509804, green: 0.0862745098, blue: 0.1215686275, alpha: 0.96)
    let acPrimary =  #colorLiteral(red: 0.26879996061325073, green: 0.6835198998451233, blue: 0.9599999785423279, alpha: 1)
    let acInactive =  #colorLiteral(red: 0.537254902, green: 0.5803921569, blue: 0.6392156863, alpha: 1)

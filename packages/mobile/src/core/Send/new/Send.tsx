...
export const SendNew: FC<SendProps> = ({ route }) => {
  ...
  const {
    ...
    fee: initialFee = '0',
    from,
    isGasless: initialIsGasless,
    isForcedGasless: initialIsForcedGasless,
    supportsGasless: initialSupportsGasless,
    customFeeCurrency: initialCustomFeeCurrency,
    expiryTimestamp,
  ...
  const subtitle = sendNavigation.isStep(SendSteps.ADDRESS) ? null : (
    <Text textAlign={'center'} numberOfLines={1} variant="body2" color="textSecondary">

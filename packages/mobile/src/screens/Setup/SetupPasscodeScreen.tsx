...
import { PasscodeKeyboard } from '@tonkeeper/shared/components/PasscodeKeyboad';
...
import {
  PasscodeInput,
  PasscodeInputRef,
} from '@tonkeeper/shared/components/PasscodeInput';
...
export const SetupPasscodeScreen = memo<SetupPasscodePageProps>((props) => {
  const { onNext } = props;
  ...
  }, [value0, value1, value2, stepAfterAnimation]);

...
const handImportedIcons = require('../assets/icons/hand-imported.json');

const sourcePath = './assets/icons/svg';
const destinationPath = './assets/icons/png';
const iconsDestinationPath = './src/components/Icon';
...
(async function doConvert() {
  ...
  try {
    ...
    `;
    fs.writeFileSync(`${iconsDestinationPath}/Icon.types.ts`, types);
    ...
    fs.writeFileSync(`${iconsDestinationPath}/IconList.native.ts`, IconsMobile);

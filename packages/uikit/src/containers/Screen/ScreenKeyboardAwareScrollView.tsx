...
interface ScreenKeyboardAwareScrollView extends ScrollViewProps {
  hideBottomSeparator?: boolean;
  indent?: boolean;
}

export type ScreenKeyboardAwareScrollViewRef = Animated.ScrollView;

export const ScreenKeyboardAwareScrollView = memo(
  forwardRef<ScreenKeyboardAwareScrollViewRef, ScreenKeyboardAwareScrollView>(
    (props, ref) => {

...
import { DevTonConnectBridge } from '$core/DevMenu/DevComponents/DevTonConnectBridge';
...
export const DevStack = () => {
  ...
  return (
    ...
    >
      <Stack.Screen name={DevComponents.DevComponentList} component={DevComponentList} />
      <Stack.Screen
        name={DevComponents.DevTonConnectBridge}
        component={DevTonConnectBridge}
      />
      <Stack.Screen name={DevComponents.DevText} component={DevText} />
      <Stack.Screen name={DevComponents.DevDeeplinking} component={DevDeeplinking} />
      <Stack.Screen name={DevComponents.DevToast} component={DevToastScreen} />
      <Stack.Screen

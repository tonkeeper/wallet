...
export const ModalStack = React.memo(() => (
  <Stack.Navigator>
    <Stack.Group behavior="sheet">
      <Stack.Modal
        component={NFTSingleDeployModal}
        path="NFTSingleDeploy"
      />
      <Stack.Modal
      ...
      />
      <Stack.Modal
        component={NFTCollectionDeployModal}
        path="NFTCollectionDeploy"
      />
      <Stack.Modal
        component={NFTItemDeployModal}
        path="NFTItemDeploy"
      />
      <Stack.Modal
        component={NFTSalePlaceModal}
        path="NFTSalePlace"
      />
      <Stack.Modal
        component={NFTSalePlaceGetgemsModal}
        path="NFTSalePlaceGetgems"
      />
      <Stack.Modal
    ...
    <Stack.Group behavior="modal">
      ...
      <Stack.Modal 
        component={Receive}
        path={AppStackRouteNames.Receive}
      />
      <Stack.Modal
        component={Send}
      ...
      <Stack.Modal
        component={ScanQR}
        path={AppStackRouteNames.ScanQR}
      />
    </Stack.Group>
    ...
    <Stack.Group behavior="fullScreenModal" animation="fade">
      ...
      />
      <Stack.Modal
        component={ResetPinStack}
        path={AppStackRouteNames.ResetPin}
      />
      <Stack.Modal
        component={Migration}
        path={AppStackRouteNames.Migration}
      />
      <Stack.Modal
      ...
      <Stack.Modal
        component={ChangePin}
        path={AppStackRouteNames.ChangePin}
      />
    </Stack.Group>
  </Stack.Navigator>
));